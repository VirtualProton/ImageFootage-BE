...
<div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(array('url' => URL::to('admin/subadmin/'.$agent_data['id']),  'method' => 'PUT', 'class'=>"form-horizontal",'id'=>'adminform','files'=> true,'autocomplete'=>false)); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 <select class="form-control" name="department" id="department">
                    ...
                    <option value=<?php echo e($depatment->id); ?> <?php if($agent_data['department']['id']==$depatment->id){echo 'selected="selected"';}?>><?php echo e($depatment->department); ?></option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="role" id="role">
                    ...
                    <option value=<?php echo e($role->id); ?> <?php if($agent_data['role']['id']==$role->id){echo 'selected="selected"';}?>><?php echo e($role->role); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </select>
                </div>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imagefootage\imagefootagenew\resources\views/admin/subadmin/edit.blade.php ENDPATH**/ ?>