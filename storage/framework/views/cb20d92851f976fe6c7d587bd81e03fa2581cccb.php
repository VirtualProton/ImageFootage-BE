    ...
    <section class="content">
        <div class="row">
        	<div class="col-md-12">
			   ...
			   <?php endif; ?>
                <form action="<?php echo e(url('admin/insert_product_category')); ?>" role="form" method="post" id="productform" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imagefootage\imagefootagenew\resources\views/admin/product/addproductcategory.blade.php ENDPATH**/ ?>