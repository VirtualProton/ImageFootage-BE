    ...
    <section class="content">
        <div class="row">
        	<div class="col-md-12">
			   ...
			   <?php endif; ?>
                <form action="<?php echo e(url('admin/editcontributor')); ?>" role="form" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                 <input type="hidden" value="<?php echo e($contributor['contributor_id']); ?>" name='contributor_id'/>
                  <div class="box-body">
                   <div class="form-group">
                      <label for="exampleInputEmail1">Contributor Name</label>
                      <input type="text" class="form-control" name="contributor_name" id="contributor_name" placeholder="Contributor Name" value="<?php echo e($contributor['contributor_name']); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="contributor_email" id="contributor_email" placeholder="Contributor Email" value="<?php echo e($contributor['contributor_email']); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="checkbox">
                          <label>
                            <input type="radio" name="contributor_type" value="For Sale" class="contributor_type" <?php if($contributor['contributor_type']=='For Sale"'): ?> checked="checked" <?php endif; ?>> For Sale
                          </label>
                          <label>
                            <input type="radio" name="contributor_type" value="Donor" class="contributor_type" <?php if($contributor['contributor_type']=='Donor'): ?> checked="checked" <?php endif; ?>> Donor
                          </label>
                    	</div>
                    </div>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imagefootage\imagefootagenew\resources\views/admin/contributor/editcontributor.blade.php ENDPATH**/ ?>