    ...
    <section class="content">
        <div class="row">
        	<div class="col-md-12">
			   ...
			   <?php endif; ?>
                <form action="<?php echo e(url('admin/addstaticpage')); ?>" role="form" method="post" enctype="multipart/form-data" id="productform">
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imagefootage\imagefootagenew\resources\views/admin/staticpages/createstaticpage.blade.php ENDPATH**/ ?>