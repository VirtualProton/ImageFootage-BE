...
class PaymentController extends Controller
{
    ...
    public function payment(Request $request){
        ...
        if($allFields['type']=='atom'){
            ...
            $transactionRequest->setLogin(106640);
            $transactionRequest->setPassword("33719eef");
            $transactionRequest->setProductId('CONCEPTUAL');
            ...
            $transactionRequest->setReqHashKey("3a1575abc728e8ccf9");
...
//            ])->send();
    ...
    public function paymentPlan(Request $request){
        ...
        if($allFields['type']=='atom'){
            ...
            $transactionRequest->setCustomerBillingAddress("India");
            $transactionRequest->setCustomerAccount($allFields['tokenData']['Utype']);
            $transactionRequest->setReqHashKey("3a1575abc728e8ccf9"); //KEY123657234
...
//            ])->send();
    ...
    public function atomPayPlanResponse(Request $request){
        $transactionResponse = new TransactionResponse();
        $transactionResponse->setRespHashKey("43af4ba2fbd68d327e"); //KEYRESP123657234
        if($transactionResponse->validateResponse($_POST)){
