...
const routes = [
    ...
    { path: 'lightbox', component: _lightbox_lightbox_component__WEBPACK_IMPORTED_MODULE_20__["LightboxComponent"] },
];
...
let DashboardComponent = class DashboardComponent {
    constructor(heroService, dataHelper, myElement, router) {
...
let HeroSearchComponent = class HeroSearchComponent {
    constructor(heroService, route, dataHelper, myElement, spinner) {
        this.heroService = heroService;
        this.route = route;
        this.dataHelper = dataHelper;
        this.myElement = myElement;
