...
let HeroDetailComponent = class HeroDetailComponent {
    constructor(route, heroService, location, dataHelper, authenticationService, router, sanitizer) {
        this.route = route;
        this.heroService = heroService;
