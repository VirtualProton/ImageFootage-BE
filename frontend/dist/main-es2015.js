...
let HeroService = class HeroService {
    ...
    getUserprofileData() {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(orderDetails => {
            console.log(orderDetails);
            //this.currentUserSubject.next(cart);
            return orderDetails;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`unable to get data`)));
