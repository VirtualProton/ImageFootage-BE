    ...
    function () {
      ...
      _createClass(HeroDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.heroService.getAosSliderImages().subscribe(function (aoslSliderImages) {
            _this18.aoslSliderImagesData = aoslSliderImages; //let tempCarouselSlider= this.chunkArray(aoslSliderImages, 4);
            ...
            _this18.aoslSliderImagesData.forEach(function (ele) {
              if (i > j) {
                ele.eleClass = randArr[j];
                j = j + 1;

                if (j == i) {
                  _this18.dataHelper.shuffleArray(randArr);
