...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(authenticationService, router, formBuilder, dataHelper) {
    ...
    CheckoutComponent.prototype.ngOnInit = function () {
        ...
        this.authenticationService.getcartItemsData()
            ...
            _this.wishListDataItems.forEach(function (element) {
                console.log(element);
                _this.priceArray.push(element["total"]);
            });
        }, function (error) {
        });
    };
...
var ContactUsComponent = /** @class */ (function () {
    ...
    ContactUsComponent.prototype.onContactSubmit = function () {
        var _this = this;
        this.submitted = true;
        // stop here if form is invalid
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.heroService.getAosSliderImages()
            ...
            _this.aoslSliderImages = aoslSliderImages;
...
var HeroDetailComponent = /** @class */ (function () {
    ...
    HeroDetailComponent.prototype.addToCheckoutItem = function (productinfo, cartproduct, total, extended, type) {
        var _this = this;
        if (!this.currentUser) {
            this.showloginPopup = true;
        }
            ...
            this.heroService.addcartItemsData(cartval_1)
                .subscribe(function (data) {
                console.log(data);
                _this.checkoutArray.push(cartval_1);
                if (data["status"] == '1') {
                    localStorage.setItem('checkoutAray', _this.checkoutArray);
    ...
    HeroDetailComponent.prototype.checkPriceTotal = function (selectedPrice) {
        console.log(selectedPrice);
        this.currunt_selected_price = selectedPrice.price * 80;
        this.total = this.currunt_selected_price;
        this.standard = selectedPrice;
    };
    HeroDetailComponent.prototype.addExtendedPriceTotal = function (selectedPrice) {
...
var HeroSearchComponent = /** @class */ (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route
            ...
            _this.searchData.letest = 1;
            _this.searchData.curated = 0;
            _this.searchData.populer = 0;
            _this.searchAPIRequest();
        });
        this.heroService.getSearchLeftFilter()
            .subscribe(function (leftsideData) {
            // this.carouselSliderImages = carouselSliderImages; 
            console.log(leftsideData);
            _this.leftsideData = leftsideData;
        });
    };
    HeroSearchComponent.prototype.searchDropDownClick = function (type) {
        this.searchData.productType = type;
    };
    HeroSearchComponent.prototype.searchAPIRequest = function () {
        var _this = this;
    ...
    HeroSearchComponent.prototype.getSideBarClassName = function (type, id) {
        if (type == 'people') {
    ...
    HeroSearchComponent.prototype.onSideMenuClick = function (type, id) {
        if (type == 'people') {
            var indexPeople = this.slidebarPeopleMenu.indexOf(id);
            if (indexPeople > -1) {
    ...
    HeroSearchComponent.prototype.onTabClick = function (number) {
        if (number == 2) {
    ...
    HeroSearchComponent.prototype.maintainSearchData = function (aoslSliderImages) {
        ...
        if (this.searchData.productType == 1) {
            this.aoslSliderImagesData = this.aoslSliderImages.filter(function (ele) { return ele.product_main_type == "Image"; });
        }
        ...
        if (this.searchData.search.length > 2) {
            this.aoslSliderImagesData = this.aoslSliderImagesData.filter(function (ele) { return ele.product_title.includes(_this.name.trim()); });
        }
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.allCountries = function () {
        var url = this.heroesUrl + "getCountyStatesCityList";
        //return this.http.get(this.countryUrl);
        return this.http.get(url);
    };
    HeroService.prototype.allstates = function (country) {
        var url = this.heroesUrl + "getCountyStatesList/" + country;
        //return this.http.get(this.countryUrl);
        return this.http.get(url);
    };
    HeroService.prototype.allCities = function (state) {
        var url = this.heroesUrl + "getStateCityList/" + state;
        //return this.http.get(this.countryUrl);
        return this.http.get(url);
    };
    ...
    HeroService.prototype.getSearchLeftFilter = function () {
        var url = this.heroesUrl + "get_side_filtes";
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (searchSideMenu) {
    ...
    HeroService.prototype.getLogin = function (email, password) {
        ...
        return this.http.post(url, { email: email, password: password }, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) {
            console.log(user);
    ...
    HeroService.prototype.contactUs = function (contactData) {
        var url = this.heroesUrl + "user_contactus";
    ...
    HeroService.prototype.getDetailPagedetails = function (id, webtype, type) {
        var _this = this;
        console.log(id);
        //const url = `api/detailPageInfo/?${id}`;
        var url = this.heroesUrl + "details/" + id + "/" + webtype + "/" + type;
    ...
    HeroService.prototype.addcartItemsData = function (product) {
        var url = this.heroesUrl + "add_to_cart";
        ...
        return this.http.post(url, { product: product }, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (cart) {
            console.log(cart);
            //this.currentUserSubject.next(cart);
            return cart;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("unable to get data")));
    };
    HeroService.prototype.removeCartItemsData = function (product) {
        console.log(product);
        var url = this.heroesUrl + "delete_cart_item";
    ...
    HeroService.prototype.getcartItemsData = function () {
        ...
        var url = this.heroesUrl + "user_cart_list";
    ...
    HeroService.prototype.payment = function (usrData, cartval) {
        var url = this.heroesUrl + "payment";
        var tokenData = JSON.parse(localStorage.getItem('currentUser'));
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + tokenData.access_token
        ...
        var options = { headers: headers };
        return this.http.post(url, { usrData: usrData, cartval: cartval, tokenData: tokenData }, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (userInfo) {
            return userInfo;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("unable to register data")));
        ;
    };
...
var SignUpComponent = /** @class */ (function () {
    ...
    SignUpComponent.prototype.onChangeCountry = function (countryValue) {
        var _this = this;
        //  console.log(this.countryInfo[countryValue]);
        this.authenticationService.allstates(countryValue).
            subscribe(function (data2) {
    ...
    SignUpComponent.prototype.onChangeState = function (stateValue) {
        var _this = this;
        // console.log(this.stateInfo[stateValue]);
        this.authenticationService.allCities(stateValue).
            subscribe(function (data2) {
    ...
    SignUpComponent.prototype.onChangeCity = function (cityValue) {
        // console.log(this.cityInfo[cityValue]);
        // this.registerForm.controls['city'].setValue(this.cityInfo[cityValue]);
    };
...
var WishlistComponent = /** @class */ (function () {
    function WishlistComponent(heroService, authenticationService, router) {
        this.heroService = heroService;
        this.authenticationService = authenticationService;
        this.router = router;
        this.wishListDataItems = [];
    ...
    WishlistComponent.prototype.removeProductFromCart = function (productinfo) {
        var _this = this;
        ...
        if (confirm('Are you sure?') == true) {
            this.heroService.removeCartItemsData(productinfo)
                .subscribe(function (data) {
                if (data["status"] == '1') {
                    _this.authenticationService.getcartItemsData()
                        .subscribe(function (data) {
                        _this.wishListDataItems = data;
                        _this.wishListDataItems.forEach(function (element) {
                            _this.priceArray.push(element["total"]);
