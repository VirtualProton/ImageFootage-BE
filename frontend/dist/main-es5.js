...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function getcategoryCarouselImages() {
          ...
          this.heroService.getcategoryCarouselImages(1).subscribe(function (images) {
            if (!Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(images)) {
              _this16.carouselSliderImages = images[0];
              var randArr = [4, 3, 2, 3];
  ...
  function srcAppOrderConfirmationOrderConfirmationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], OrderConfirmationComponent);
    /***/
  },
    ...
    function () {
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function getCountries() {
          ...
          this.authenticationService.allCountries().subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this38.countryInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
        ...
        value: function onChangeCountry(countryValue) {
          ...
          this.authenticationService.allstates(countryValue).subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this39.stateInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
        ...
        value: function onChangeState(stateValue) {
          ...
          this.authenticationService.allCities(stateValue).subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this40.cityInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
    ...
    function () {
      ...
      _createClass(WishlistComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authenticationService.getcartItemsData().subscribe(function (data) {
            _this42.wishListDataItems = data;

            _this42.wishListDataItems.forEach(function (element) {
              _this42.priceArray.push(element["total"]);
            });
        ...
        value: function removeProductFromCart(productinfo) {
          ...
          if (confirm('Are you sure?') == true) {
            this.heroService.removeCartItemsData(productinfo).subscribe(function (data) {
              if (data["status"] == '1') {
                _this43.authenticationService.getcartItemsData().subscribe(function (data) {
