...
var HeroSearchComponent = /** @class */ (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route
            ...
            _this.searchBoxLabel = params.type;
            _this.name = params.keyword;
            _this.heroService.getAosSliderImages()
                .subscribe(function (aoslSliderImages) {
                // console.log(aoslSliderImages);
                // console.log(aoslSliderImages.filter(ele=> ele.name.includes(this.name)));
                _this.aoslSliderImages = aoslSliderImages;
                _this.maintainSearchData(aoslSliderImages);
            });
        });
        this.heroService.getcarouselSliderImages()
            .subscribe(function (carouselSliderImages) {
    ...
    HeroSearchComponent.prototype.maintainSearchData = function (aoslSliderImages) {
        ...
        if (this.searchBoxLabel == 'all') {
            ...
            this.aoslSliderImagesData = this.aoslSliderImages.filter(function (ele) { return ele.type == _this.searchBoxLabel; });
        }
        if (this.name.length > 2) {
            this.aoslSliderImagesData = this.aoslSliderImagesData.filter(function (ele) { return ele.name.includes(_this.name.trim()); });
        }
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        ...
        return { heroes: heroes, carouselImages: carouselImages, aosImages: aosImages, userData: userData, detailPageCarouselImages: detailPageCarouselImages, detailPageInfo: detailPageInfo, marketFreeze: marketFreeze, cartItemsData: cartItemsData };
    };
