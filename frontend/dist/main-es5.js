      ...
      _createClass(CheckoutComponent, [{
        ...
        value: function onChangeCountry(countryValue) {
          ...
          this.authenticationService.allstates(countryValue).subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this4.stateInfo = data2;
            _this4.loadingData = false; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
      ...
      _createClass(ContributorSignUpComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.authenticationService.contributorRegister(this.form).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data2) {
            ...
            if (data2.status == '1') {
              _this8.otp = true;
              _this8.error_message = null;
              _this8.success_message = data2.message;
            } else {
              _this8.otp = false;
              _this8.success_message = null;
              _this8.error_message = data2.message;
            }
          }, function (error) {
        ...
        value: function onSubmitotp() {
          ...
          this.authenticationService.verifyOtp(email, mobile, this.contributorotpForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data2) {
            ...
            if (data2.status == '1') {
              ...
              _this10.contributorotpForm.reset();

              _this10.completflag = true;
    ...
    function () {
      function DashboardComponent(heroService, dataHelper, myElement, router) {
        ...
        this.onPageChange = function (pageNumber) {
          var el = _this11.myElement.nativeElement.querySelector('ngb-carousel');
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.heroService.getcarouselSliderImages().subscribe(function (data) {
            ...
            _this12.carouselSliderImages = _carouselSliderArray;
            ;
          ...
          this.heroService.getAosSliderImages().subscribe(function (aoslSliderImages) {
            ...
            _this12.aoslSliderImages = aoslSliderImages;
            _this12.aoslSliderImagesData = aoslSliderImages;

            _this12.maintainAosSlider();
          });
        }
      }, {
        key: "getClassName",
        ...
        value: function maintainAosSlider() {
          ...
          this.aoslSliderImagesData.forEach(function (ele) {
            if (i > j) {
              ...
              if (j == i) {
                _this13.dataHelper.shuffleArray(randArr);
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this.route.queryParams.subscribe(function (params) {
            _this15.productType = params.type;
            _this15.keywordEle = params.keyword;
          });
        }
      }, {
        key: "searchDropDownClick",
    ...
    function () {
      ...
      _createClass(HeroDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.heroService.getAosSliderImages().subscribe(function (aoslSliderImages) {
            _this17.aoslSliderImagesData = aoslSliderImages; //let tempCarouselSlider= this.chunkArray(aoslSliderImages, 4);
            ...
            _this17.aoslSliderImagesData.forEach(function (ele) {
              if (i > j) {
        ...
        value: function getDetailinfo() {
          ...
          this.heroService.getDetailPagedetails(this.id, this.webtype, this.type).subscribe(function (data) {
            console.log(data);
            _this18.detailPageInfo = data;

            if (_this18.webtype == 2) {
              var keywords = _this18.detailPageInfo['metadata']['keywords_top10'];
              _this18.keyword = keywords.split(",").map(function (item) {
                return item.trim();
              });
            } else if (_this18.webtype == 3) {
              var _keywords = _this18.detailPageInfo[0].items[0].kw;
              _this18.keyword = _keywords.split(",").map(function (item) {
                return item.trim();
              });
        ...
        value: function getcategoryCarouselImages() {
          ...
          this.heroService.getAosSliderImages().subscribe(function (aoslSliderImages) {
            if (!Object(util__WEBPACK_IMPORTED_MODULE_6__["isNullOrUndefined"])(aoslSliderImages)) {
              _this19.carouselSliderImages = aoslSliderImages;
              var randArr = [4, 3, 2, 3];

              var tempCarouselSlider = _this19.chunkArray(_this19.carouselSliderImages.categoryImages, 4);

              _this19.carouselSliderImages.categoryImages = JSON.parse(JSON.stringify(tempCarouselSlider));

              for (var i = 0; i < _this19.carouselSliderImages.categoryImages.length; i++) {
                if (_this19.carouselSliderImages.categoryImages[i].length < 4) {
                  var lessItem = 4 - _this19.carouselSliderImages.categoryImages[i].length;
                  var newArray = tempCarouselSlider[0].splice(0, lessItem);
                  _this19.carouselSliderImages.categoryImages[i] = _this19.carouselSliderImages.categoryImages[i].concat(newArray);
                }
              }

              _this19.carouselSliderImages.categoryImages.forEach(function (element) {
                var temp = 0;
        ...
        value: function addToCheckoutItem(productinfo, cartproduct, total, extended, type) {
          ...
          if (!this.currentUser) {
            ...
            this.heroService.addcartItemsData(cartval).subscribe(function (data) {
              ...
              _this20.checkoutArray.push(cartval);

              if (data["status"] == '1') {
                _this20.loadingData = false;
                localStorage.setItem('checkoutAray', _this20.checkoutArray);

                _this20.router.navigate(['/wishlist']);
              } else {
                _this20.loadingData = false;
                alert(data["message"]);
              }
  ...
  function srcAppHeroSearchHeroSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HeroSearchComponent(heroService, route, dataHelper, myElement, spinner) {
        ...
        this.onPageChange = function (pageNumber) {
          var el = _this21.myElement.nativeElement.querySelector('main');
      ...
      _createClass(HeroSearchComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this.route.queryParams.subscribe(function (params) {
            _this22.loadingData = true; //  this.spinner.show();

            _this22.searchData.productType = params.type;
            _this22.searchData.search = params.keyword;

            if (!Object(util__WEBPACK_IMPORTED_MODULE_8__["isNullOrUndefined"])(params.sideBar)) {
              _this22.sideBarEle = params.sideBar;
            }

            _this22.searchData.letest = 0;
            _this22.searchData.curated = 1;
            _this22.searchData.populer = 0;

            _this22.searchAPIRequest();
          });
          this.heroService.getSearchLeftFilter().subscribe(function (leftsideData) {
            // this.carouselSliderImages = carouselSliderImages; 
            console.log(leftsideData);
            _this22.leftsideData = leftsideData;
          });
        }
      }, {
        key: "searchDropDownClick",
        ...
        value: function searchAPIRequest() {
          ...
          this.heroService.getAosSliderSearchImages(this.searchData).subscribe(function (aoslSliderImages) {
            _this23.aoslSliderImages = aoslSliderImages;
            var type = _this23.aoslSliderImages["0"].product_keywords;
            _this23.keyword = type.split(',', 9);
            console.log(_this23.keyword);

            _this23.maintainAosSlider(); //  this.spinner.hide();


            _this23.loadingData = false; // this.maintainSearchData(aoslSliderImages);
          });
        }
      }, {
        ...
        value: function maintainSearchData(aoslSliderImages) {
          ...
          if (this.searchData.search.length > 2) {
            this.aoslSliderImagesData = this.aoslSliderImagesData.filter(function (ele) {
              return ele.product_title.includes(_this24.name.trim());
            });
          }
        ...
        value: function maintainAosSlider() {
          ...
          this.aoslSliderImages.forEach(function (ele) {
            if (i > j) {
              ...
              if (j == i) {
                _this25.dataHelper.shuffleArray(randArr);
      ...
      _createClass(HeroService, [{
        ...
        value: function getcategoryCarouselImages(categoryId) {
          ...
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this27.log("fetched CarouselImages id=".concat(categoryId));
        ...
        value: function getDetailPagedetails(id, webtype, type) {
          ...
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this28.log("fetched detail Page Info id=".concat(id));
        ...
        value: function getMarketdeatils() {
          ...
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this29.log("fetched market Info id");
        ...
        value: function getHeroes() {
          ...
          return this.http.get(this.heroesUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this30.log('fetched heroes');
        ...
        value: function getHeroNo404(id) {
          ...
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (h) {
            ...
            _this31.log("".concat(outcome, " hero id=").concat(id));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getHero id=".concat(id))));
        }
        ...
        value: function getHero(id) {
          ...
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this32.log("fetched hero id=".concat(id));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getHero id=".concat(id))));
        }
        ...
        value: function searchHeroes(term) {
          ...
          return this.http.get("".concat(this.heroesUrl, "/?name=").concat(term)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this33.log("found heroes matching \"".concat(term, "\""));
        ...
        value: function addHero(hero) {
          ...
          return this.http.post(this.heroesUrl, hero, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (newHero) {
            return _this34.log("added hero w/ id=".concat(newHero.id));
        ...
        value: function deleteHero(hero) {
          ...
          return this.http.delete(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this35.log("deleted hero id=".concat(id));
        ...
        value: function updateHero(hero) {
          ...
          return this.http.put(this.heroesUrl, hero, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
            return _this36.log("updated hero id=".concat(hero.id));
        ...
        value: function handleError() {
          ...
          return function (error) {
            ...
            _this37.log("".concat(operation, " failed: ").concat(error.message)); // Let the app keep running by returning an empty result.
        ...
        value: function onSubmit() {
          ...
          this.authenticationService.getLogin(this.f.email.value, this.f.password.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(function (data) {
            ...
            if (data == undefined) {
              ...
              _this40.closeLoginPopup.emit(true);
            }
          }, function (error) {
        ...
        value: function ngOnInit() {
          ...
          this.authenticationService.getOrderDetails(this.id).subscribe(function (data) {
            if (data.status == 'success') {
              _this41.OrderDetailData = data.data[0];
    ...
    function () {
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function getCountries() {
          ...
          this.authenticationService.allCountries().subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this42.countryInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
        ...
        value: function onChangeCountry(countryValue) {
          ...
          this.authenticationService.allstates(countryValue).subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this43.stateInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
        ...
        value: function onChangeState(stateValue) {
          ...
          this.authenticationService.allCities(stateValue).subscribe(function (data2) {
            //this.countryInfo=data2.Countries;
            _this44.cityInfo = data2; //console.log('Data:', this.countryInfo);
          }, function (err) {
            return console.log(err);
          }, function () {
            return console.log('complete');
    ...
    function () {
      ...
      _createClass(WishlistComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authenticationService.getcartItemsData().subscribe(function (data) {
            _this46.wishListDataItems = data;

            _this46.wishListDataItems.forEach(function (element) {
              _this46.priceArray.push(element["total"]);
            });

            _this46.loadingData = false; //this.spinner.hide();
          }, function (error) {});
        }
      }, {
        key: "showTotalPrice",
          ...
          if (confirm('Are you sure?') == true) {
            ...
            this.heroService.removeCartItemsData(productinfo).subscribe(function (data) {
              if (data["status"] == '1') {
                ...
                _this47.authenticationService.getcartItemsData().subscribe(function (data) {
                  _this47.wishListDataItems = data;

                  _this47.wishListDataItems.forEach(function (element) {
                    _this47.priceArray.push(element["total"]);
                  });
