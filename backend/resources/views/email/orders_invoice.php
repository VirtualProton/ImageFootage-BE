                  ...
                  <tbody>
                     ...
                     <?php //echo "<pre>"; print_r($orders); die; ?>
                           <td colspan="2" width="302">
                              <p>Customer Name: <strong><?php echo $orders['bill_firstname'] ?> <?php echo $orders['bill_lastname'] ?></strong></p>
                              <p>Address: <strong><?php echo $orders['bill_address1'] ?> </strong><?php echo $orders['city']['name'] ?>&nbsp;&nbsp;  <?php echo $orders['state']['state'] ?>&nbsp;&nbsp;<?php //echo $orders['postal_code'] ?></p>
                              <!-- <p>Phone: <strong><?php //echo $orders['mobile'] ?></strong></p> -->
                              <br/>
                           </td>
                           <td colspan="2" width="304">
                              <p>Invoice No.: <strong><?php echo $orders['txn_id'] ?></strong></p>
                              <p>Invoice Date: <strong><?php echo date("F , d Y",strtotime($orders['created_at'])) ?></strong></p>
                              <!-- <p>GSTIN: <strong><?php ////echo $orders['gst'] ?></strong></p>
                              <p>PAN No.: <strong><?php //echo $orders['pan'] ?></strong></p>
                              <p>SAC Code: <strong></strong></p> -->
                              <p>Place: <strong><?php echo $orders['bill_address1'] ?>&nbsp;&nbsp;  <?php echo $orders['state']['state'] ?><br /> </strong>Payment Due: <strong>Online</strong></p>
                              <br/> <br/>
                           </td>
                     </tr>
                     <tr>
                           <td colspan="2" width="302">
                              <p>Kind Attention: <br /> <strong><?php echo $orders['bill_firstname'] ?> <?php echo $orders['bill_lastname'] ?></strong><br /></p>
                           </td>
                           <td colspan="2" width="304">
                     ...
                     <tr>
                           <td colspan="2" width="302">
                              <p>Total number of image(s)/footage(s)/Package(s): <br/> <strong> <?php echo count($orders['items']); ?>
                              </strong></p>
                              <br/>
                              <br/>
                           </td>   
                     ...
                     <tr>
                        <?php $i=0; foreach($orders['items'] as $k=>$value) { if($value['product_web'] != '5'){  ?>
                           <td width="150">
                              <?php //if($value['product_web']=='2'){ ?>
                                 <img src="<?php echo $value['product_thumb'] ?>" alt="image" width="140px" height="150px">
                              <?php //} ?>
                              <p>Image ID: <?php echo $value['product_id'] ?></p>
                              <p>Size: <?php echo $value['product']['product_size'] ?></p>
                              <p>Cost: <strong>INR <?php echo number_format($value['total'], 2) ?>/-</strong></p>
                           </td>
                        <?php if(($k+1)%4 == 0) { ?>
                                 </tr><tr>
                              <?php }
                     ...
                     <?php
                        foreach($orders['items'] as $k=>$value) { if($value['product_web'] == '5') {  ?>
                           <tr>
                              <td width="150">
                                 <p>Size: <?php echo $value['product_name'] ?></p>
                              </td>
                              <td width="150">
                                 <p>Cost: <strong>INR <?php echo number_format($value['standard_price'], 2) ?>/-</strong></p>
                              </td>
                           </tr>
                     <?php } } ?>
                     <tr>
                        ...
                        <td colspan="2" width="304" class="bgtdright">
                           <p><strong> <?php echo number_format(($orders['order_total'] - $orders['tax']), 2) ?></strong></p>
                        </td>
                     </tr>
                        <?php if(!empty($orders['tax'])) { ?>
                           <tr>
                              ...
                              <td colspan="2" width="304" class="bgtdright">
                                 <p><strong><?php echo number_format($orders['tax'], 2) ?></strong></p>
                              </td>
                           </tr>
                        <?php } ?>
                     <tr>
                           ...
                           <td colspan="2" width="304" class="bgtdright">
                              <p><strong><?php echo number_format($orders['order_total'], 2) ?></strong></p>
                           </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                           <td colspan="4" width="609">
                              ...
                              <p>8.For online payments please click the link below<br></p>
                           </td>
                     </tr>
                  </tbody>
               </table>
