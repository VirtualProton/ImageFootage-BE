                 ...
                 <tr>
                        ...
                        <tr>
                           ...
                           <tr>
                              ...
                              <td style="color: #fc8041; font-weight: 700"><?php echo date("F , d Y",strtotime($quotation[0]['created'])) ?></td>
                           </tr>
                           <tr>
                              <td style="color: #fc8041; font-weight: 700">Quote expiration:</td>
                              <td style="color: #fc8041; font-weight: 700"><?php echo date("F , d Y",strtotime($quotation[0]['created'])) ?></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              <td colspan="2">
                                 ...
                                 <p style="margin: 0px;"><?php echo $quotation[0]['city'] ?></p>
                                 <p style="margin: 0px;"><?php echo $quotation[0]['state'] ?></p>
                                 <p style="margin: 0px;"><?php echo $quotation[0]['postal_code'] ?></p>
                                 <p style="margin: 0px;"><?php echo $quotation[0]['country'] ?></p>
                              </td>
                           </tr>
                        </table>
                     </div>
               ...
               <tr class="rr2">
                  <td colspan="2">
                     <div class="qoutedeail" style="text-align: left;">
                        <h2 style="margin-bottom: 10px; padding: 0px 12px; ">Quote Details</h2>
                        <table width="100%">
