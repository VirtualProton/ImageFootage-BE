 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Contributor</li>
      </ol>
    </section>
        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Contributor</h3><a href="{{ URL::to('admin/contributor_list') }}" class="btn pull-right">Back</a>
                </div>
                 ...
                 <input type="hidden" value="{{ $contributor['contributor_id'] }}" name='contributor_id'/>
                  <div class="box-body">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="contributor_name" id="contributor_name" placeholder="Contributor Name" value="{{ $contributor['contributor_name'] }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="contributor_email" id="contributor_email" placeholder="Contributor Email" value="{{ $contributor['contributor_email'] }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="contributor_mobile" id="contributor_mobile" placeholder="Contributor Mobile" value="{{ $contributor['contributor_mobile'] }}">
                   ...
                   <?php /* <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="checkbox">
                          <label>
                            <input type="radio" name="contributor_type" value="For Sale" class="contributor_type" @if($contributor['contributor_type']=='For Sale"') checked="checked" @endif> For Sale
                          </label>
                          <label>
                            <input type="radio" name="contributor_type" value="Donor" class="contributor_type" @if($contributor['contributor_type']=='Donor') checked="checked" @endif> Donor
                          </label>
                    	</div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="bank_holder_name" id="bank_holder_name" placeholder="Bank Holder Name" value="{{ $contributor['contributor_accountholder'] }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Bank Name" value="{{ $contributor['contributor_bank'] }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="bank_account_number" id="bank_account_number" placeholder="Bank Account Number" value="{{ $contributor['contributor_banknumber'] }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ifsc_number" id="ifsc_number" placeholder="IFSC number" value="{{ $contributor['contributor_ifsc'] }}">
                    </div>
