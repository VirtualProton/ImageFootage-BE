 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit API Quata</li>
      </ol>
    </section>
        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Edit API Quata</h3><a href="{{ URL::to('admin/api_quota_list') }}" class="btn pull-right">Back</a>
                </div>
			   ...
			   @endif
                <form action="{{ url('admin/editapiquata') }}" role="form" method="post" enctype="multipart/form-data" id="productform">
                <input type="hidden" class="form-control" name="api_id" id="api_id"  value="{{ $package[0]['api_id'] }}">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                  
                   <div class="form-group">
                      <label for="exampleInputEmail1">API Provider</label>
                      <input type="text" class="form-control" name="api_provider" id="api_provider" placeholder="Package name" value="{{ $package[0]['api_provider'] }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="api_amount" id="api_amount" placeholder="Package Price" value="{{ $package[0]['api_amount'] }}">
                    </div>
