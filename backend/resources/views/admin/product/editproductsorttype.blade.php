 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Edit Product Sort Type</li>
      </ol>
    </section>
        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"> Edit Product Sort Type</h3><a href="{{ URL::to('admin/product_sort_type_list') }}" class="btn pull-right">Back</a>
                </div>
			   ...
			   @endif
                <form action="{{ url('admin/updatproductsort_type') }}" role="form" method="post" enctype="multipart/form-data" id="productform">
                 ...
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_sort_type" id="product_sort_type" placeholder="Product Sort Type" value="{{ $page[0]['name'] }}">
                       @if ($errors->has('product_sort_type'))
                      		<div class="has_error" style="color:red;">{{ $errors->first('product_sort_type') }}</div>
                       @endif
                    </div>
                  </div>
                  <!-- /.box-body -->
