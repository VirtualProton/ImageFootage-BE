...
@section('content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add Product Image Orientations
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Add Product Image Orientations</li>
      </ol>
    </section>
        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Add Product Image Orientations</h3><a href="{{ URL::to('admin/product_orientations_list') }}" class="btn pull-right">Back</a>
                </div>
			   ...
			   @endif
                <form action="{{ url('admin/addproduct_orientations_process') }}" role="form" method="post" enctype="multipart/form-data" id="productform">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                   <div class="form-group">
                      <label for="exampleInputEmail1">Product Orientations </label>
                      <input type="text" class="form-control" name="product_orientations" id="product_orientations" placeholder="Product Orientations">
