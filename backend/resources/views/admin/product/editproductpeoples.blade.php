        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"> Edit Product Peoples</h3><a href="{{ URL::to('admin/product_image_peoples_list') }}" class="btn pull-right">Back</a>
                </div>
			   ...
			   @endif
                <form action="{{ url('admin/updateproductpeoples') }}" role="form" method="post" enctype="multipart/form-data" id="productform">
                 ...
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_peoples" id="product_peoples" placeholder="Product Peoples" value="{{ $page[0]['name'] }}">
