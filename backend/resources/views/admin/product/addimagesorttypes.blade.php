        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Add Product Sort Type</h3><a href="{{ URL::to('admin/product_sort_type_list') }}" class="btn pull-right">Back</a>
                </div>
                 ...
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_sort_type" id="product_sort_type" placeholder="Product Sort Type">
