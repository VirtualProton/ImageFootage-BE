        ...
        <div class="row">
        	<div class="col-md-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"> Edit Product Color</h3><a href="{{ URL::to('admin/product_colors_list') }}" class="btn pull-right">Back</a>
                </div>
			   ...
			   @endif
                <form action="{{ url('admin/updateproductcolor') }}" role="form" method="post" enctype="multipart/form-data" id="productform">
                 ...
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_color_name" id="product_color_name" placeholder="Product Color Name" value="{{ $page[0]['name'] }}">
                       @if ($errors->has('product_color_name'))
                      		<div class="has_error" style="color:red;">{{ $errors->first('product_color_name') }}</div>
                       @endif
                    </div>
                  </div>
                  <!-- /.box-body -->
