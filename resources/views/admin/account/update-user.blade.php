...
<div class="">
  ...
  <div class="form-group col-sm-6">
    ...
    <div class="user-name-dec">
      ...
      <div class="custom-width custom-font">
        @if(Auth::guard('admins')->user()->role_id == 1)
        Deactivated ? :
        <select class="form-control" name="user_status" id="user_status" style="width: auto; display: inline-block;">
          <option value="1" @if($user->status == 1) selected="selected" @endif>No</option>
          <option value="0" @if($user->status == 0) selected="selected" @endif>Yes</option>
        </select>
        @else
