                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="checkbox" style="margin-bottom: 5px;">
                                <label>
                                    <input type="checkbox" name="access_management[{{$eachmodule->id}}]['view']">
                                    Can View/Search
                                </label>
                            </div>
                            <div class="checkbox" style="margin-bottom: 5px;">
                                <label style="display: block;">
                                    <input type="checkbox" name="access_management[{{$eachmodule->id}}]['add']">
                                    Can Add
                                </label>
                            </div>
                            <div class="checkbox" style="margin-bottom: 5px;">
                                <label style="display: block;">
                                    <input type="checkbox" name="access_management[{{$eachmodule->id}}]['edit']">
                                    Can Edit
                                </label>
                            </div>
                            <div class="checkbox" style="margin-bottom: 5px;">
                                <label style="display: block;">
                                    <input type="checkbox" name="access_management[{{$eachmodule->id}}]['delete']">
                                    Can Remove
                                </label>
                            </div>
                        </div>
