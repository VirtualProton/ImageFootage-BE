                           ...
                           <div class="col-sm-12">
                              <div class="col-lg-6 col-md-4 col-xs-4 repeated-dv " ng-repeat="product in quotation.product track by $index">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input ng-if="product.type=='Footage' || product.type=='Image'" type="text" class="form-control" ng-model="product.name" name="product_name" id="product_<%$index+1%>" required="" ng-blur="getproduct(product,'custom')">
