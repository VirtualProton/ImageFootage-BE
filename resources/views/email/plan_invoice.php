...
<table width="600" data-table data-tablelook="1184" border="2" align="center">
   <tbody>
      <tr>
         <td data-celllook="4369">
            <p style="font-size: 11px;">Customer Name:&nbsp;<strong><?php echo $orders['user']['first_name'] ?> <?php echo $orders['user']['last_name'] ?></strong>&nbsp;</p>
            <p style="font-size: 11px;">Address:&nbsp;<strong> <?php echo $orders['user']['address'] ?></strong></p>
            <p style="font-size: 11px;"><strong><?php echo $orders['user']['city']['name'] ?>&nbsp;&nbsp; <?php echo $orders['user']['state']['state'] ?>&nbsp;&nbsp;<?php echo $orders['user']['postal_code'] ?></strong></p>
            <p style="font-size: 11px;">Phone:&nbsp;<strong><?php echo $orders['user']['phone'] ?></strong>&nbsp;</p>
         </td>
         <td data-celllook="4369">
            <p style="font-size: 11px;">Transaction ID &nbsp;No.:&nbsp;<strong><?php echo $orders['transaction_id'] ?></strong>&nbsp;</p>
            <p style="font-size: 11px;">Transaction Date &nbsp;:&nbsp;<strong><?php echo date("F , d Y h:i:s a", strtotime($orders['created_at'])) ?></strong>&nbsp;</p>
            <p style="font-size: 11px;">Plan Expiry Date &nbsp;:&nbsp;<strong><?php echo date("F , d Y h:i:s a", strtotime($orders['package_expiry_date_from_purchage'])) ?></strong>&nbsp;</p>
            <p style="font-size: 11px;">Place:&nbsp;<strong><?php echo $orders['user']['state']['state'] ?> &ndash; <?php echo $orders['user']['country']['name'] ?></strong>&nbsp;</p>
         </td>
      </tr>
      <tr>
         <td data-celllook="4369">
      ...
      <tr>
         ...
         <td data-celllook="69905">
            <p style="font-size: 11px;"><strong>INR&nbsp;</strong><strong><?php echo $orders['package_price'] ?></strong>&nbsp;</p>
         </td>
      </tr>
      <tr>
         <td colspan="2" data-celllook="69905">
            <p style="font-size: 11px;">Add:&nbsp;GST @ 12%&nbsp;</p>
         </td>
      </tr>
      <tr>
         <td colspan="2" data-celllook="4369">
            ...
            <p style="font-size: 13px;">&nbsp;<br /><strong>With&nbsp;</strong><strong>a</strong><strong>Standard</strong><strong>&nbsp;license, you may:</strong>&nbsp;</p>
            <ul>
            ...
            <p style="font-size: 13px;"><strong>With a&nbsp;</strong><strong>Standard</strong><strong>&nbsp;license, you may not:</strong>&nbsp;</p>
            <ul>
            ...
            <p style="font-size: 13px;">&nbsp;<br /><strong>Credit Packs</strong>&nbsp;</p>
            <ul>
            ...
            <p style="font-size: 13px;">&nbsp;<br /><strong>Enhanced Team Licensing Terms:</strong>&nbsp;</p>
            <p style="font-size: 13px;">Enhanced licenses are available for Adobe Stock Premium collection images, videos, templates, editorial and 3D assets.</p><br />
            ...
            <p style="font-size: 13px;">&nbsp;<br /><strong>Terms of&nbsp;</strong><strong>Payment:</strong>&nbsp;</p>
            <ul>
...
<table data-table data-tablelook="1184" width="600" align="center">
   <tbody>
      <tr>
         <td data-celllook="4369">
            <p style="font-size: 11px;">&nbsp;<br /><strong><?php config('constants.company_name') ?>&nbsp;</strong>&nbsp;<br />3rd Floor, # 10-3-89/A/B, R-5 Chambers, Near Sarojini Devi Hospital, Humayun Nagar,&nbsp;Hyderabad - 500028,&nbsp;Telangana,&nbsp;Andhra&nbsp;Pradesh, India&nbsp;Phone: +91 40 6720 6720 Fax +91 40 6673 8077&nbsp;</p>
            <p style="font-size: 11px;"><a href="http://about:blank/">info@imagefootage.com</a> <a href="http://about:blank/">www.imagefootage.com</a>&nbsp;</p>
         </td>
         <td data-celllook="273">
