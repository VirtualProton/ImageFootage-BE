    ...
    <footer>
        <div class="container">
            <div class="footer-left">
                <h2 class="h4"><strong>
                        <?php config('constants.company_name') ?>
                    </strong></h2>
            ...
            <div class="container">
                <div class="client-info-top">
                    <div class="client-info-leftside">
                        <p>Customer Name: <span><strong>
                                    <?php echo $orders['user']['first_name'] ?>
                                    <?php echo $orders['user']['last_name'] ?></span></strong></p>
                        <p>Address: <span><strong>
                                    <?php echo $orders['bill_address1'] ?>
                                </strong></span>
                            <span class="block-text" style="white-space: break-spaces; display:inline;">
                                <?php echo $orders['city']['name'] ?>&nbsp;&nbsp;
                                <?php echo $orders['state']['state'] ?>&nbsp;&nbsp; -
                                <?php echo $orders['bill_zip'] ?></strong>
                            </span>
                        </p>
                        <p>Mobile: <span><strong>
                                    <?php echo $orders['user']['mobile'] ?>
                                </strong></span></p>
                        <p>GSTIN: <span><strong>
                                    <?php echo $orders['user']['gst'] ?>
                                </strong></span></p>
                        <p>PAN: <span><strong>XXX
                                    <?php echo $orders['user']['pan'] ?>
                                </strong></span></p>
                    </div>
                    <div class="client-info-rightside">
                        <p>Invoice No.: <span><strong>
                                    <?php echo config('constants.INVOICE_PREFIX') ?></span></strong></p>
                        <p>Invoice Date: <span><strong>
                                    <?php echo date("d.m.Y ", strtotime($orders['created_at'])) ?>
                                </strong></span></p>
                        <p>GSTIN: <span><strong>
                                    <?php echo config('constants.GSTIN_VALUE') ?>
                                </strong></span></p>
                        <p>PAN No.: <span><strong>
                                    <?php echo config('constants.PAN_VALUE') ?>
                                </strong></span></p>
                        <p>SAC Code: <span><strong>
                                    <?php echo config('constants.SAC_CODE') ?>
                                </strong></span></p>
                        <p>Place: <span><strong>
                                    <?php echo config('constants.QI_ADDRESS') ?>
                                </strong></span></p>
                ...
                <div class="client-info-bottom">
                    ...
                    <div class="client-info-rightside">
                        <p>Purchase Order No.: <span class="block-text" style="display:inline;"><strong>
                                    <?php echo $orders['id'] ?>
                                </strong></span></p>
                        <p>dated <span><strong>
                ...
                <div class="client-info-bottom">
                    <div class="client-info-leftside">
                        <p>Total number of image(s)/footage(s): <span class="block-text"><strong>
                                    <?php echo count($orders['items']); ?>
                                </strong></span></p>
                    </div>
                    <div class="client-info-rightside">
                        <p>IF Sales Representative: <span class="block-text"><strong>Admin</strong></span></p>
                        <p>Client: <span><strong>
                                    <?php echo $orders['user']['company'] ?>
                                </strong></span></p>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <table width="100%" style="border-collapse: collapse;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    if (!empty($orders['items'][$i])) {
                                                        if ($orders['items'][$i]['product_web'] == '4') {
                                                            $subtotalarray = $subtotalarray + $orders['items'][$i]['total'];
                                                        } else {
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="4" style="font-size: 16px;">
                                                        <p style="margin: 0px;"><span>In words:</span><strong>
                                                                <?php echo 'Rupees ' . $amount_in_words . ' only'; ?>
                                                            </strong>
                                                        </p>
                                                    </td>
                                                </tr>
