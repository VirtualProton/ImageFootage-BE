...
<head>
    ...
    <title>Image-Footage Quotation</title>
    <?php
    $documentLabel = strtoupper(trim((string) ($quotation[0]['document_label'] ?? 'Estimate')));
    ...
    $estimateNumber = 'Q' . trim((string) ($quotation[0]['invoice_name'] ?? ''));
    $estimateDate = !empty($quotation[0]['invicecreted']) ? date('d.m.Y', strtotime($quotation[0]['invicecreted'])) : '';
    ...
    $terms = [
        'This estimate is valid for 30 days from the date of issue unless stated otherwise. Pricing and availability may change after that period.',
        ...
        'All disputes are subject to Hyderabad jurisdiction. Please notify us immediately if any estimate detail needs correction before processing.',
    ];
    ?>
    <style>
        * {
                ...
                <tr>
                    <td>
                        <table class="detail-pairs" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="detail-label">Estimate No.</td>
                                <td class="detail-value"><?php echo htmlspecialchars($estimateNumber); ?></td>
                            </tr>
                            <tr>
                                <td class="detail-label">Estimate Date</td>
                                <td class="detail-value"><?php echo htmlspecialchars($estimateDate); ?></td>
                            </tr>
                            <tr>
            ...
            <div class="items-table">
                ...
                <?php foreach ($quotation as $index => $item) {
                    ...
                    <table class="item-card-table" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="item-card-sr serial-number"><?php echo $index + 1; ?></td>
                            <td class="item-card-description description-column">
                                <div class="item-content-wrap">
                                    <p class="item-title description-title"><?php echo htmlspecialchars($itemTitle); ?></p>
                                    <table class="item-card-inner description-content" cellpadding="0" cellspacing="0">
                                        <colgroup>
                                        ...
                                        <tr>
                                            ...
                                            <td class="item-card-meta-cell">
                                                <table class="item-meta-table asset-meta" cellpadding="0" cellspacing="0">
                                                    <colgroup>
                            ...
                            <td class="item-card-price unit-price"><?php echo $currencySymbol; ?><?php echo number_format((float) ($item['subtotal'] ?? 0), 2); ?></td>
                        </tr>
                    </table>
                <?php } ?>
            </div>
