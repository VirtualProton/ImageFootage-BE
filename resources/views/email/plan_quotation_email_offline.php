                ...
                <tbody>
                    <tr>
                        ...
                        <td width="30%">
                            ...
                            <p> &nbsp;&nbsp;<strong><?php //echo date("F , d Y h:i:s a",strtotime($orders['package_expiry_date_from_purchage'])) 
                                                    ?></strong>&nbsp;</p>
                        ...
                        <td data-celllook="272">
                            <p>
                                <span data-contrast="auto">
                                  Product&nbsp;Description:&nbsp;&nbsp;<br /><strong></strong><strong>
                                    <?php
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <p>
                                <a href="http://about:blank/"><strong>S</strong><strong>tandard</strong><strong>&nbsp;Team Licensing Terms</strong></a><a href="http://about:blank/"><strong>:</strong></a>&nbsp;
