                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="border-radius:23px;">
                                                                                        <span style="font-family: 'Poppins', sans-serif;font-size: 18px;line-height:23px;color:#FFFFFF;text-align:center;font-weight: 600;text-decoration: none;background-color: #007BFF;border-radius: 23px;padding: 12px 24px;display: inline-block;">
                                                                                            {{ $otp ?? '' }}
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
