              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('reset.password.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              <label for="password-confirm" class="col-md-12 col-form-label text-md-right">Confirm Password</label>
                              <div class="col-md-12">
                          ...
                          <div class="col-md-12 offset-md-4 forget-pas-btn link-blade-pas">
