                                                                    ...
                                                                    <td style="font-size:0;vertical-align:middle">
                                                                        <div style="vertical-align:top;width:100%;max-width:100%;display:inline-block">
                                                                            <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="font-family: 'Poppins', sans-serif;font-size: 31px;line-height:40px;color:#000000;text-align:center;font-weight: 500;">Your account has been created by the administrator.</td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="font-family: 'Poppins', sans-serif;font-size: 14px;line-height:29px;color:#3F4246;text-align:center;font-weight: 500;padding-bottom: 39px;">
                                                                                            Please click the below link for activate your contributor account.
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="border-radius:23px;">
                                                                                        <a href="{{ $cont_url ?? '#' }}" style="display:inline-block;background-color:#21E277;font-family: 'Poppins', sans-serif;font-size:16px;line-height:16px;color:#ffffff;font-weight: 500;text-decoration:none;border-radius:23px;padding-top:16px;  padding-right: 25px; padding-bottom: 16px; padding-left: 25px;" target="_blank">Click here to authenticate your account</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
